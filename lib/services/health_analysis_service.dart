...
class HealthAnalysisService {
  static const String _apiKey =
      'AIzaSyAS1H4mMZbgVqowCH_mYZAmJFh-hfgUPgA'; // Ganti dengan API key Anda
...
''';
      ...
      return response.text ??
          'Tidak dapat menganalisis data kesehatan saat ini.';
    } catch (e) {
  ...
  static String _getFallbackAnalysis(
    ...
    if (sleepHours >= 7) {
      achievements +=
          '• Durasi tidur optimal (${sleepHours.toStringAsFixed(1)} jam) 😴\n';
    }

    String improvements = '';
    if (steps < 5000) {
      improvements +=
          '• Tingkatkan aktivitas fisik, targetkan 8,000 steps/hari\n';
    }
    if (sleepHours < 7) {
